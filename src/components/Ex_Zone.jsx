...
const Ex_Zone = ({ answers, setAnswers, parentAnswers, setParentAnswers, disabled, onPopup }) => {
  ...
  return (
    <div
      className={`bg-[#fdf5eb] shadow-xl rounded-2xl p-6 mb-8 mt-8 ${
      ...
      <div className="space-y-6 mb-8">
        {experienceQuestions.map((question, idx) => (
          ...
          >
            ...
            <div
              onClick={() => handleToggle(idx)}
              className={`relative w-16 h-7 rounded-full transition-colors duration-300 flex items-center px-1 ml-4 ${
                disabled

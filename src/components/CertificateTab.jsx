...
//   // Build certificate DOM element - matching the exact format from your code
...
//     // Using student name in filename
...
//     console.log(
//       `Certificate ready for ${student.name}. Size: ${(finalSize / (1024 * 1024)).toFixed(
//         2
...
//       return true;
//     } catch (err) {
//       console.error("Failed to send certificate to email:", err);
//       alert(
...
//   // Button handler: generate (compressed) and email
...
//       } else {
//         alert(`Certificate downloaded successfully for ${student.name}!`);
//       }
//     } catch (e) {
//       console.error(e);
...
//               disabled={!certificateData?.chapters || Object.keys(certificateData.chapters).length === 0}
//             >
//               <option value="">Select a chapter</option>
//               {certificateData?.chapters &&
//                 Object.keys(certificateData.chapters).sort().map((chapterName) => (
...
//         {/* Table Header */}
//         <div className="grid grid-cols-4 border-b-2 border-black bg-[#fdf5eb]">
//           <div className="p-3 border-r-2 border-black font-semibold text-center">
//             Name
//           </div>
//           <div className="p-3 border-r-2 border-black font-semibold text-center">
//             Email
...
//         {/* Table Body */}
//         <div className="min-h-[300px] max-h-[500px] overflow-y-auto bg-[#fdf5eb]">
...
//                 return (
//                   <div key={`${student.email}-${index}`} className="grid grid-cols-4">
//                     {/* Name */}
//                     <div className="p-3 border-r-2 border-black flex items-center justify-center">
//                       <span className="text-sm text-center">{student.name}</span>
//                     </div>
                    
//                     {/* Email */}
//                     <div className="p-3 border-r-2 border-black flex items-center justify-center">
//                       <span className="text-sm break-all text-center">{student.email}</span>
//                     </div>
                    
//                     {/* School */}
//                     <div className="p-3 border-r-2 border-black flex items-center justify-center">
//                       <span className="text-sm text-center">{student.school}</span>
//                     </div>
...
//                         className={`px-4 py-2 border-2 border-black rounded-full transition-colors text-sm font-medium ${
//                           isGenerating 
//                             ? 'bg-gray-200 cursor-not-allowed' 
//                             : 'bg-[#fdf5eb] hover:bg-gray-100'
//                         }`}
//                       >
